from gtno_py.inference.inference_utils import parse_inference_args
from gtno_py.training import Config, eval_epoch, create_dataloaders_single, create_dataloaders_multitask
import torch
from gtno_py.training import initialize_model
...
def main() -> None:
    ...
    try:
        model_state_dict: OrderedDict[str, torch.Tensor] = torch.load(args.model, weights_only=True)
    except FileNotFoundError:
